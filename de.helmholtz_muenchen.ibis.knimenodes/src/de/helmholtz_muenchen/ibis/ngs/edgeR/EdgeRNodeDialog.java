...
public class EdgeRNodeDialog extends HTExecutorNodeDialog {
	...
	public void addToolDialogComponents() {
		final SettingsModelString SET_CORRECTION	= new SettingsModelString(EdgeRNodeModel.CFGKEY_CORRECTION_METHOD, EdgeRNodeModel.DEFAULT_CORRECTION_METHOD);
	    final SettingsModelString SET_NORM_FACTOR	= new SettingsModelString(EdgeRNodeModel.CFGKEY_NORMALIZE_METHOD_FACTOR, EdgeRNodeModel.DEFAULT_NORMALIZE_METHOD_FACTOR);
