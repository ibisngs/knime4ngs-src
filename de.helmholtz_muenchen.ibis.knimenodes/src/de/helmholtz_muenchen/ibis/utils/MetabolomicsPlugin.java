 ...
 * @author Max
 */
public class MetabolomicsPlugin extends Plugin {
    // The shared instance.
    private static MetabolomicsPlugin plugin;

    /**
     * The constructor.
     */
    public MetabolomicsPlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static MetabolomicsPlugin getDefault() {
        return plugin;
    }
