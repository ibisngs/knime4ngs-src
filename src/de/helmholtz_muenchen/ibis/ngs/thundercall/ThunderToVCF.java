...
import de.helmholtz_muenchen.ibis.utils.ngs.frost.FastaCheck;
...
//			System.out.println(s);
	...
	protected void convertThunder2VCF (String thunderOutFile, String thunder2VCFOutFile) throws IOException {
		// TODO Auto-generated method stub
		ThunderToVCF t2vcf = new ThunderToVCF();
		t2vcf.getThunderInfo(thunderOutFile); // get the infos parsed, get the contigs
		BufferedWriter bw = new BufferedWriter(new FileWriter(thunder2VCFOutFile));
