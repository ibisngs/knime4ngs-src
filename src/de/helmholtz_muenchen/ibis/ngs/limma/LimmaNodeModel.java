...
/**
 * This is the model implementation of Limma.
 * 
 *
 * @author Michael Kluge
 */
public class LimmaNodeModel extends RNodeModel {
	...
	private static final NodeLogger LOGGER = NodeLogger.getLogger(LimmaNodeModel.class);
	
	private static final String SCRIPT_PATH = "ngs" + File.separatorChar + "de" + File.separatorChar + "limma.R";
	...
	protected static final ArrayList<String> NORM_CPM = new ArrayList<String>();
	...
	static {
		...
		NORM_CPM.add("cyclicloess");
		NORM_CPM.add("scale");
		NORM_CPM.add("quantile");
		NORM_CPM.add("none");
    ...
    private DataTableSpec getSpec(DataTableSpec inSpec) {
    	DataColumnSpec[] specs = DataTableSpec.createColumnSpecs(new String[]{"ID", "log2FC", "aveLog2CPM", "B", "t", "PValue", "adj.PValue"}, new DataType[]{DataType.getType(StringCell.class), DataType.getType(DoubleCell.class), DataType.getType(DoubleCell.class), DataType.getType(DoubleCell.class), DataType.getType(DoubleCell.class), DataType.getType(DoubleCell.class), DataType.getType(DoubleCell.class)});
    ...
    protected DataTableSpec[] configure(final DataTableSpec[] inSpecs) throws InvalidSettingsException {
    	...
    	this.addArgument("--normCPM", this.SET_METHOD_CPM.getStringValue());
