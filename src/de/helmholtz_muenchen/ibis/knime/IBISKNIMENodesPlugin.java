...
//	public static final String BFAST = "bfast";
	...
	public static String [] PATHS = {REF_GENOME, DB_FILE, BCFTOOLS, BOWTIE2, BWA, FEATURE_COUNTS, GATK, PINDEL, PINDEL2VCF, SAMTOOLS, SEGEMEHL, STAR, VCFTOOLS, VEP, VEP_FILTER};
